...
const char rcsid_scc_driver_h[] = "@(#)$KmKId: scc_driver.h,v 1.6 2002-11-19 00:10:38-08 kadickey Exp $";

/* This file contains the Unix socket calls */

#if defined(HPUX) || defined(__linux__) || defined(SOLARIS) || defined(__POWERPC__)
int
